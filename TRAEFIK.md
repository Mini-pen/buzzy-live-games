...
`traefik.http.routers.partygames-http.middlewares=redirect-to-https@docker`

et sur le router HTTPS :

`traefik.http.routers.partygames-https.middlewares=security-headers@docker`
